# Gráficos de temperaturas y lluvias en el Perú
...
Aplicamos la función a Lima - Callao del 82 en adelante:
```{r create_baselpot, fig.width=6, fig.height=6}
#| echo: false

p <- make_base_weekly_heatmap(
    weekly_dataset = 
...
## Heatmaps nacionales - Escala fija

```{r national_heatmap_weekly, fig.width=8, fig.height=20}
#| echo: false
...
p <- make_base_weekly_heatmap(
    weekly_dataset = 
        filter(weekly_averages,
               year > 1981,
               city %in% c("Arequipa", "Chiclayo",      "Cusco",    "Iquitos", 
                           "Juliaca",  "Lima - Callao", "Pisco",    "Piura", 
                           "Pucallpa", "Tacna",         "Trujillo", "Tumbes"
                           )),
    custom_breaks = c(1990, 2000, 2010, 2020),
    custom_limits = c(1974, 2035)) + 
...
p
```
## Heatmaps nacionales - Escala libre

```{r national_heatmap_weekly_free, fig.width=8, fig.height=20}
#| echo: false
selected_stations <- filter(weekly_averages,
               year > 1981,
               city %in% c("Arequipa", "Chiclayo",      "Cusco",    "Iquitos", 
                           "Juliaca",  "Lima - Callao", "Pisco",    "Piura", 
                           "Pucallpa", "Tacna",         "Trujillo", "Tumbes"
...
plots <- lapply(unique_cities, function(ciudad) {
    df_subset <- filter(selected_stations,
                        city == ciudad)
...
plot_combined <- wrap_plots(plots, ncol = 2)  # Adjust ncol as needed
