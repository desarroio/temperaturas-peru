...
# Importar datos de NOAA

 - Perú (estaciones con más de 66% de cobertura de datos)
 - Lima (estación Aeropuerto Jorge Chávez)

```{r}
#| echo: false
per_80_23_noaa <- read_csv(
    "data/NOAA_PER_1980_2023.csv",
    col_types = cols(
        DATE = col_date(format = "%Y-%m-%d"),
        SNWD = col_double())
    )

lim_63_23_noaa <- read_csv(
    "data/NOAA_Lima2.csv",
...
df_names <- c("per_80_23_noaa", "lim_63_23_noaa")
