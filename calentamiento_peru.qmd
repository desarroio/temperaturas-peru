...
Usamos la función para crear heatmap de Lima - Callao del 82 en adelante:
...
- Creamos una lista de anotaciones

```{r annotation_list}
annotations_list <- list(
    # Inicio de año
    annotate("text", x = 1981, y = 3.5, 
             label = "Semana 1\nde 1982", 
             size = 3.5, color = "#F9F7F3", family = "Sanchez", vjust = 1, hjust = 1),
    geom_curve(aes(x = 1981, y = 1, xend = 1979, yend = 3),
               curvature = 0.3, color = "#F9F7F3", linewidth = 0.2,
               arrow = arrow(type = "closed", length = unit(0.05, "inches"))),
    # Última semana
    geom_curve(aes(x = 2023.2, y = 46, xend = 2024.5, yend = 48),
               curvature = 0.3, color = "#F9F7F3", linewidth = 0.2,
               arrow = arrow(type = "closed", length = unit(0.05, "inches"))),
    annotate("text", x = 2025, y = 47,
             label = "Semana 45\nde 2023",
             angle = 0, hjust = 0,
